...
Для создания локального репозитория выполняются следующие действия:
* Запускаем программу Git-bash
* С помощью комманды "mkdir <directory name>" создаем новую рабочую директорию
* Командой "cd <directory name>" переходим в необходимую директорию
* Вводим команду "git init" для инициализации пустого репозитория в текущей директории
* Далее выполняем работу по созданию/редактированию файлов в рабочей папке (директории)
