...
Как ясно из самого заголовка, git  - система контроля версий. Он сохраняет не файлы, а непосредственно изменения в репозитории. Вообще, я делала инструкцию в домашке, поэтому сейчас лучше запощу вам своего котика ![Асгарда](Assguard.jpg)
