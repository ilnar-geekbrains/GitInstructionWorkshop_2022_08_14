...
[Башня](https://www.git-tower.com/learn/git/ebook/) — это клиентский инструмент git, доступный как для Mac, так и для Windows. Наряду с инструментом на веб-сайте есть бесплатная онлайн-книга для визуального изучения Git с красочными изображениями, позволяющими легко понять концепции.
