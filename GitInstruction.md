...
Система контроля версий служит для облегчения процесса разработки, позволяя одновременно работать нескольким разработчикам. Возможности системы:
* возможность хранить различные версии проекта
* возможность возвращаться к различным версиям проекта
 Git - программа, которая управляет процессом хранения версий.
