...
Также очень удобно работать с большим проектам, можно раздать программистам определённые задачи, и каждый будет работать в своей ветке, не нарушая всю систему.
