...
Переходим на сайт code.visualstudio.com, секция Download. Здесь есть версия под Mac, Linux. Нажимаем и скачиваем нужную версию себе на ПК. Запускаем инсталлятор и следуем инструкциям: принимаем, добавляем все галочки, далее, ждем пока программа установится на наш ПК.
