...
**Ветки(branches)** нужны для создания альтернативной версии вашего проекта, либо их можно использовать как
черновики, чтобы не навредить работающей версии проекта в ветке main/master

Также, при желании можно вернуться на несколько коммитов назад и Git предложит создать новую ветку,
тем самым можно начать создавать "альтернативную историю" проекта
