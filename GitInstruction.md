...
Хранилище данных (Репозиторий). Нужны для заполнения, сохранения, перемещения информации. Легко сохранить существующую версию своего проекта и создать изменения (Обновление) для своего проекта. Сохранить вторую версию и так далее.
Также очень удобно работать с большим проектам, можно раздать программистам определённые задачи, и каждый будет работать в своей ветке, не нарушая всю систему. Очень удобно.
