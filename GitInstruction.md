...
Система контроля версий это архив внесений изменений в код. Благодаря системе контроля версий, программист может вернуться на определенную стадию в дереве  проекта, которая ему нужна.
...
Репозиторий это папка на компьютере, в которой активирована система контроля версий git. Для создания репозитория нужно сначала создать папку, а потом инициализировать git в командной строке командой git init
...
Ветки это ответвления в дереве создания кода. Они нужны для того, что бы можно было работать над проектом совместно, но у каждого программиста своя ветка. Таким образом не нужно скачивать или оперировать большим объемом данных.

### Базовая работа с ветками в git.

Для git веток есть команды 

git branch _эта команда показывает все ветки проекта и подсвечивает символом звездочка на какой мы сейчас ветке_

git checkout branch_name _эта команда переносит нас на ветку с именем branch_name_

git merge branch_name _эта команда сливает ветку с именем branch_name в текущую ветку_
